  ...
  const MENU = [
    {
      ...
      description: "Здесь вы можете увидеть экспонаты нашего школьного музея",
    ...
    {
      id: "page2",
      name: "Коллекция археологического музея",
      price: 9.5,
      image: "https://maksim15132.github.io/museum/assets/arxe-museum.jpg",
      description: "Здесь вы можете увидеть экспонаты предоставленные в рамках сотрудничества с Курским археологическим музеем",
      link: "https://maksim15132.github.io/museum/arxe-museum/",
    },
    {
      id: "page3",
      name: "Литература",
